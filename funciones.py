...
def crear_linea_2(fecha_hora,
    ...
    linea_completa = f"{fecha_hora}{cantidad_total_registros}{valor_total_pagos}{cantidad_registros_abono_cuenta}{valor_total_abono}{cantidad_registros_pago_ventanilla}"
